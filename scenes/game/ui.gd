...
const BUILDING_ICON = preload("")
const BUILDING_DESTROYED_ICON = preload("")

const BUILDER_ICON = preload("res://assets/mask/builder_icon.png")
const DESTROYER_ICON = preload("res://assets/mask/destroyer_icon.png")
